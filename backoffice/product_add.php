					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">เพิ่มข้อมูลสินค้า</h3>
			            </div>
			            <div class="panel-body container-fluid">
			              	<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="urlname" name="urlname" placeholder="product-name" required>
				                </div>
				                <div class="form-group" data-plugin="formMaterial">
				                ...
				                <div class="form-group" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="price" name="price" placeholder="189">
				                </div>
				                <div class="form-group" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="pdtype">ประเภทสินค้า</label>
				                  	<input type="text" class="form-control" id="product_type" name="product_type" placeholder="ANTI-ACNE SOLUTION">
				                </div>
				                <div class="form-group" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="short_desc">รายละเอียดแบบย่อ</label>
				                  	<input type="text" class="form-control" id="short_desc" name="short_desc" placeholder="รายละเอียดแบบย่อ">
				                </div>
								<div class="form-group" data-plugin="formMaterial">
				                ...
				                <div class="form-group form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="images">รูปภาพ</label>
