...
<body class="animsition dashboard">
				...
				<div class="col-xxl-12 col-lg-12">
					...
					<div class="panel">
						...
						<div class="panel-body container-fluid">
							...
							<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post"
								...
								<div class="form-group form-material-file" data-plugin="formMaterial">
									...
									<input type="file" id="covImg" name="covImg" data-plugin="dropify"
										data-default-file="" data-allowed-file-extensions="png jpg" />

									<i class="help-block"><i>Image size: 1950x680px | File Size < 2MB</i> </p> </div>

												<div class="form-group form-material-file" data-plugin="formMaterial">

												<label class="form-control-label" for="image">รูปภาพ (Mobile)</label>

												<input type="file" id="covImgMB" name="covImgMB" data-plugin="dropify"
													data-default-file="" data-allowed-file-extensions="png jpg" />

												<i class="help-block"><i>File Size < 2MB</i>
															</p> </div> <div class="text-right">

															<button type="submit"
																class="btn btn-animate btn-animate-side btn-success">

																<span><i class="icon wb-check" aria-hidden="true"></i>
																	บันทึก</span>
															...
															<button type="button"
																...
																onclick="window.location.href = 'banner.php';">

																<span><i class="icon wb-close" aria-hidden="true"></i>
																	ยกเลิก</span>
	...
	<script type="text/javascript" src="plugin/bootstrap-datetimepicker-4.17.37/bootstrap-datetimepicker.min.js">
	</script>
