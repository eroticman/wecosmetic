					...
					<!-- Panel Static Labels -->
		          	...
		          	<div class="panel">
			            ...
			            <div class="panel-heading">
			              ...
			              <h3 class="panel-title">แก้ไขรูปภาพแบนเนอร์</h3>
			            ...
			            <div class="panel-body container-fluid">
			              	...
			              	<form id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
								...
								<input type="file" id="covImgMB" name="covImgMB" data-plugin="dropify" data-default-file="<?php echo '../img/banner/' . $banner_detail->id . '/' . $banner_detail->img_cover_mb; ?>" data-allowed-file-extensions="png jpg"/>

								<i class="help-block"><i>File Size < 2MB</i></p>
