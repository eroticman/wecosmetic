										...
										<div class="bs-bars pull-left">
											...
											<div class="btn-group hidden-sm-down" id="exampleToolbar" role="group">
												...
												<button type="button" class="btn btn-success btn-outline btn-sm"
													onclick="window.location.href = 'banner_add.php';">
									...
									<div class="" style="padding-bottom: 0px;">
										...
										<div class="fixed-table-body">
											...
											<table id="exampleTableToolbar" data-mobile-responsive="true"
												class="table table-hover" data-pagination="true" data-search="true"
												...
												<thead style="">
													...
													<tr>
														...
														<th style="" data-field="img-mb" data-align="center">

															<div class="th-inner ">รูปภาพ(Mobile)</div>
														...
														<th style="" data-field="edit" data-align="center"
															data-width="120px">
												...
												<tbody>
													...
													<tr>
														...
														<td style=>
														<?php if(!empty($banner_detail->img_cover)): ?>
														<img
																src="../img/banner/<?php echo $banner_detail->id; ?>/<?php echo $banner_detail->img_cover; ?>"
																style="width:200px;">
														<?php endif ?>	
																
																</td>
														<td style=>
														<?php if(!empty($banner_detail->img_cover_mb)): ?>
																<img src="../img/banner/<?php echo $banner_detail->id; ?>/<?php echo $banner_detail->img_cover_mb; ?>"
																style="width:200px;">
														<?php endif ?>	
																</td>
														...
														<td>
															...
															<button type="button"
																...
																onclick="window.location.href = 'banner_edit.php?id=<?php echo $banner_detail->id; ?>';"><i
																	class="icon wb-pencil"
																	aria-hidden="true"></i></button>

															<button type="button"
																class="btn btn-round btn-danger btn-sm"
																onclick="delS(<?php echo $banner_detail->id; ?>)"><i
																	class="icon wb-close"
																	aria-hidden="true"></i></button>
		...
		<div class="modal-dialog modal-sm">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-success" onclick="deleteBanner()"><i class="fa fa-check"></i>
						ยืนยัน</button>
